            ...
            <div class="card card-primary">
              <form method="post" action="{{ url('admin/admin/add') }}">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label >Email</label>
                    <input type="email" class="form-control" name="email" required value="{{ $getRecord->email }}"  placeholder="Email">
                  </div>
                  <div class="form-group">
                    <label >Password</label>
                    <input type="text" class="form-control" name="password"  placeholder="Password">
                    <p>Do you wan to change password please add new password</p>
                  </div>
                </div>
