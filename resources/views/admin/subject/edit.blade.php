              ...
              <form method="post" action="{{ url('admin/subject/edit/'.$getRecord->id) }}">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="name" class="form-control" name="name" value="{{ $getRecord->name }}"  required placeholder="Subject Name">
                  </div>
                  <div class="form-group">
                    ...
                    <select class="form-control" name="type" required>
                        ...
                        <option {{ ($getRecord->type == 'Revision') ? 'selected':'' }} value="Revision">Revision</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label >Status</label>
